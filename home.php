                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-text center-align">
                                        <h5>No Posts in your Home Page</h5>
                                        <h6>Try Follow These People</h6>
                                    ...
                                    ORDER BY RAND() LIMIT 3";
                                        ...
                                        <div>
                                            ...
                                            <form action="actions/add_follower.php" method="post">
                                                ...
                                                <button class="btn btn-small button--rounded button--primary--outline" type="submit" name="submit-follow">follow
                                                </button>
                                            </form>
                                        </div>
                                <?php 
